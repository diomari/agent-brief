...
[![npm version](https://img.shields.io/npm/v/brief-ctx.svg)](https://www.npmjs.com/package/brief-ctx)
[![npm downloads](https://img.shields.io/npm/dm/brief-ctx.svg)](https://www.npmjs.com/package/brief-ctx)
[![license: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![CI](https://github.com/diomari/brief-ctx/actions/workflows/ci.yml/badge.svg)](https://github.com/diomari/brief-ctx/actions/workflows/ci.yml)
[![Node.js >=22.6](https://img.shields.io/badge/node-%3E%3D22.6-339933.svg)](package.json)
...
Generated by `brief-ctx` via `/brief` (compact). Package version: 1.2.0. Run `/brief --full` for a broader brief. Re-run `/brief` whenever architecture gets stale.
